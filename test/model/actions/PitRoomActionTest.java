...
/**
 * Tests the PitRoomAction class.
 * @author Liam Scholte
 *
 */
public class PitRoomActionTest {
  ...
  @Test
  public void test() {
    PitRoomAction action = new PitRoomAction(new EmptyRoomAction());
    ModelPlayer player = new MockPlayer();
    
    boolean[] eventRaised = new boolean[1];
    player.getFellIntoPitEvent().addListener(() -> eventRaised[0] = true);
